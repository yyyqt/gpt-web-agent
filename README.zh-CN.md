...
每个人都要在自己的电脑上安装，并使用自己的 ChatGPT 连接和 Platform 隧道权限。当前是实验版，尚未发布到 npm 或 ChatGPT 插件商店。完整页面位置、成功标志和排错步骤见[上手教程](docs/GETTING-STARTED.zh-CN.md)；实现细节见[技术参考](docs/REFERENCE.zh-CN.md)、[安全说明](SECURITY.md)和[验证记录](docs/VALIDATION.md)。
